...
public class RotSpikes : MonoBehaviour
{
    ...
    void CreateCircle()
    {
        ...
        for (int i = 0; i < segments; i++)
        {
            ...
            // vertices[i * 2] = new Vector3(x * (radius - width * 0.5f), y * (radius - width * 0.5f), 0);
            // vertices[i * 2 + 1] = new Vector3(x * (radius + width * 0.5f), y * (radius + width * 0.5f), 0);
            vertices[i * 2] = new Vector3(0f, y * (radius - width * 0.5f), x * (radius - width * 0.5f));
            vertices[i * 2 + 1] = new Vector3(0f, y * (radius + width * 0.5f), x * (radius + width * 0.5f));
